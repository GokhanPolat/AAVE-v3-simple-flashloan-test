...
_verbose_ :; ## for test verbosity use 'verbose=vvv' at the end of command, v count can be up 5
...
# CONTRACTS ###################################################################
AAVEv3FLASHLOAN_TEST       = ./test/AAVEv3_SimpleFlashLoanExample.t.sol
AAVEv3FLASHLOAN_SCRIPT     = ./script
AAVEv3_SimpleFlashLoanExampleScript = ./script/AAVEv3_SimpleFlashLoanExample.s.sol
...
###############################################################################
#                           AAVEv3 SIMPLE FLASH LOAN                          #
###############################################################################

AAVEv3_simpleFlashLoan-Sepolia :; ## AAVE v3 Simple Flash Loan example
	${FORGE_SCRIPT_WITH_CONTRACTS} ${AAVEv3FLASHLOAN_SCRIPT} ${AAVEv3_SimpleFlashLoanExampleScript} --rpc-url ${RPC_SEPOLIA} --broadcast -vvv
